...
PIPELINE_MODULES = [
    ...
    "backend.app.services.prescription_document_parser",
    ...
    "backend.app.services.gemini_doctor_report_composer_client",
    "backend.app.services.doctor_report_text_safety",
    "backend.app.services.doctor_report_composer_service",
